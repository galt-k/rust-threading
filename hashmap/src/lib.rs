...
// keeps track of a Vector of vectors
...
// Adding constraints on the K, such that it should be hashable and comparable
impl<K, V> HashMap<K, V>
where
    K: Hash + Eq,
{
    // Return the bucket number, basic hashing and moudlo operation 
    ...
    // Resize operation.
    // iterate the bucket entries and return the relevant using a match operation.
    ...
    // Inserting a new key into the hashmap. 
